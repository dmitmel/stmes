...
#define MPU_REGION_FLASH_NUM 0
#define MPU_REGION_FLASH_BASE 0x08000000ul
#define MPU_REGION_FLASH_END 0x0807FFFFul

#define MPU_REGION_SRAM1_NUM 1
#define MPU_REGION_SRAM1_BASE 0x20000000ul
#define MPU_REGION_SRAM1_END 0x2001FFFFul

#define MPU_REGION_SRAM1_BB_NUM 2
#define MPU_REGION_SRAM1_BB_BASE 0x22000000ul
#define MPU_REGION_SRAM1_BB_END 0x23FFFFFFul
