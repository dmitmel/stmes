...
// 7. [13] - is an application-specific command
//
...
#define SDMMC_RESPONSE_FORMAT(n) (((n) << SDMMC_RESPONSE_FORMAT_Pos) & SDMMC_RESPONSE_FORMAT_Msk)
...
enum SdmmcCommand {
  ...
  SD_ACMD6_SET_BUS_WIDTH = 6 | SD_CMD_R1 | SD_ACMD,
  ...
  SD_ACMD13_SD_STATUS = 13 | SD_CMD_R1 | SD_ACMD,
  ...
  SD_ACMD22_SEND_NUM_WR_BLOCKS = 22 | SD_CMD_R1 | SD_ACMD,
  SDMMC_CMD23_SET_BLOCK_COUNT = 23 | SD_CMD_R1,
  SD_ACMD23_SET_WR_BLK_ERASE_COUNT = 23 | SD_CMD_R1 | SD_ACMD,
  ...
  SD_ACMD41_SD_SEND_OP_COND = 41 | SD_CMD_R3 | SD_ACMD,
  SD_ACMD42_SET_CLR_CARD_DETECT = 42 | SD_CMD_R1 | SD_ACMD,
  ...
  SD_ACMD51_SEND_SCR = 51 | SD_CMD_R1 | SD_ACMD,
